...
check-dw-trim-reflection: $(BIN_DIR)/check_dw_trim_reflection
	./$(BIN_DIR)/check_dw_trim_reflection Inputfile/database/D_on_W
...
$(BIN_DIR)/check_dw_trim_reflection: tools/check_dw_trim_reflection.cpp src/Reflect.cpp include/Reflect.h | $(BIN_DIR)
	$(CCOMPILE) -I ./include tools/check_dw_trim_reflection.cpp src/Reflect.cpp -o $@
